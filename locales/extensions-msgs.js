...
export default {
  ...
  "zh-cn": {
    "alexa.accessAccount": "登录账号: 用户名 [USERNAME] 密码 [PASSPHRASE]",
    "alexa.acessCode": "获取访问码",
    "alexa.age": "年龄",
    "alexa.band": "band",
    "alexa.command": "Command",
    "alexa.createAccount": "创建账号: 用户名 [USERNAME] 密码 [PASSPHRASE]",
    "alexa.location": "地址",
    "alexa.messageAlexa": "发消息给Alexa: [MESSAGE]",
    "alexa.movie": "电影",
    "alexa.tellAlexaItsFavorite": "告诉Alexa它最喜欢的 [ATTRIBUTE] 是 [VALUE]",
    "alexa.tellAlexaMy": "告诉Alexa我的 [ATTRIBUTE] 是 [VALUE]",
    "alexa.tellAlexaMyCurrent": "告诉Alexa我目前的 [ATTRIBUTE] 是 [VALUE]",
    "alexa.tellAlexaMyFavorite": "告诉Alexa我最喜欢的 [ATTRIBUTE] 是 [VALUE]",
    "cognimate.bored": "无聊",
    "cognimate.endMission": "结束当前任务",
    "cognimate.happy": "开心",
    "cognimate.hello": "你好",
    "cognimate.hey": "嗨",
    "cognimate.introduction": "简介",
    "cognimate.missionNumber": "任务编号",
    "cognimate.sad": "难过",
    "cognimate.say": "说",
    "cognimate.setvoice": "设置声音为 [VOICE]",
    "cognimate.shocked": "震惊",
    "cozmo.connect": "连接机器人",
    "cozmo.forward": "下一步",
    "cozmo.hello": "你好",
    "cozmo.look": "看着 [EMOTION]",
    "cozmo.pickUpBlock": "选取模块",
    "cozmo.reverse": "重置",
    "cozmo.setDownBlock": "放置模块",
    "cozmo.speak": "说",
    "cozmo.stop": "停",
    "cozmo.turn": "转动 [ANGLE] 度",
    "ergo.addRobotIP": "此处添加你的机器人IP",
    "ergo.base": "base",
    "ergo.connect": "连接Ergo",
    "ergo.curious": "好奇",
    "ergo.rest": "rest",
    "ergo.setMotors": "设置发动机 [MOTORS] 颜色为 [COLOR]",
    "ergo.setPosture": "设置动作",
    "ergo.setRobotIP": "设置机器人IP地址",
    "ergo.tetris": "tetris",
    "ergo.turnTo": "转至 [DIRECTION]",
    ...
    "feelings.feelings": "心情感受",
    "feelings.getFeeling": "这篇文字的感觉是怎样的",
    "feelings.whenNegative": "当文字是消极的",
    "feelings.whenNeutral": "当文字是中性的",
    "feelings.whenPositive": "当文字是积极的",
    "gdxfor.down": "下",
    ...
    "general.white": "白色",
    "general.yellow": "黄色",
    "general.yourTextHere": "此处输入你的文字",
    "hue.brightness": "亮度",
    "hue.changeLightProperty": "改变灯 [INDEX]的 [PROPERTY] [VALUE]",
    "hue.color": "颜色",
    "hue.saturation": "饱和度",
    "hue.setLightColor": "设置灯 [INDEX] 的颜色为 [VALUE]",
    "hue.setLightProperty": "设置灯 [INDEX] 的 [PROPERTY] 为 [VALUE]",
    "hue.smartLights": "智能灯",
    "hue.turnLightOnOff": "调节灯 [INDEX] [VALUE]",
    ...
    "muse.blink": "当我闪烁的时候",
    "muse.connect": "连接Muse",
    "muse.getSignal": "获取 [TEXT] 的值？",
    "muse.leftEar": "左耳",
    "muse.leftSensor": "左传感器",
    "muse.rightEar": "右耳",
    "muse.rightSensor": "右传感器",
    ...
    "speech.getLatestSpeech": "获取最新的语音",
    "speech.listenAndWait": "听候语音输入",
    "speech.speechReporter": "语音输入",
    "speech.speechToText": "语音转换文字",
    "speech.startSpeechRecognition": "开始收听",
    "speech.stopSpeechRecognition": "停止收听",
    "speech.whenIHear": "当听到[PHRASE]",
    "speech.whenIHearPhrase": "当我听的时候",
    "text.categoryName": "类别名称",
    "text.classifyText": " [TEXT] 是怎样类型的短语？",
    "text.getClassifier": "选择文字模型",
    "text.getScore": "你对这段文字是一个 [CLASS] 有几成把握？",
    "text.modelName": "模型名称",
    "text.phrase": "短语",
    "text.setCategory": "Set category to train",
    "text.setReadAPI": "设置读取API密钥为",
    "text.setUsername": "设置用户名为",
    "text.setWriteAPI": "设置写入API密钥为",
    "text.textTraining": "文本训练",
    "text.trainText": "发送文本 [TEXT] 至训练",
    "text.whenText": "文本什么时候是一个 [CLASS]？",
    "text2speech.alto": "中音",
    ...
    "twitter.getTopTweet": "大多数 [CATEGORY] 的推特包含#[HASH]",
    "twitter.latestUserTweet": "获取 @[USER] 最新的推特",
    "twitter.popular": "流行的",
    "twitter.recent": "最近的",
    ...
    "videoSensing.setVideoSource": "设置视频来源为 [SOURCE]",
    ...
    "vision.addLink": "此处添加链接",
    "vision.addPhoto": "添加图片至 [LABEL]",
    "vision.choosePreTrained": "选择已训练的模型",
    "vision.clearResults": "清除结果",
    "vision.getModelfromString": "选择图像模型",
    "vision.howSure": "你对这个图片是一个 [CLASS] 有几成把握？",
    "vision.modelId": "模型编号",
    "vision.searchImage": "链接搜索图片",
    "vision.searchPrediction": "搜索你的图片预测结果",
    "vision.setAPI": "设置API密钥为",
    "vision.takePhoto": "从摄像头拍照",
    "vision.video": "调整视频至 [VIDEO_STATE]",
    "vision.visionTraining": "图像训练",
    "vision.whatDoYouSee": "你从照片中看到什么？",
    "vision.whenImageIs": "当图片是 [LABEL] 的时候",
